/****************************************************************************
** Meta object code from reading C++ file 'file_select_widget.hpp'
**
...
#include "../../../src/frontend/file_select_widget.hpp"
...
#error "The header file 'file_select_widget.hpp' doesn't include <QObject>."
...
constexpr auto qt_meta_stringdata_CLASSFileSelectWidgetENDCLASS = QtMocHelpers::stringData(
    "FileSelectWidget",
    "fileSelected",
    "",
    "QString&",
...
void FileSelectWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &FileSelectWidget::fileSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileSelectWidget::fileSelected(QString & _t1)
{
